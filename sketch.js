...
var GameOverImage,RestartImage,GroundImage,Obstacle1Image,Obstacle2Image,Obstacle3Image,Obstacle4Image,Obstacle5Image,Obstacle6Image,TrexImage,Trex_collidedImage,
    Trex_runningImage,CloudImage;
...
function preload(){
  ...
  Obstacle1Image=loadImage("obstacle1-1.png");
  Obstacle2Image=loadImage("obstacle2-1.png");
  Obstacle3Image=loadImage("obstacle3-1.png");
  Obstacle4Image=loadImage("obstacle4-1.png");
  Obstacle5Image=loadImage("obstacle5-1.png");
  Obstacle6Image=loadImage("obstacle6-1.png");
  TrexImage=loadImage("trex1-1.png");
  Trex_collidedImage=loadImage("trex_collided-1.png");
  CloudImage=loadImage("cloud-1.png")
   Trex_runningImage=loadImage("trex4-1.png" ,"trex3-1.png");
...
function setup() {
  ...
  trex.addAnimation("running", Trex_runningImage);
...
function reset(){
  ...
  trex.changeAnimation("running",Trex_runningImage);
